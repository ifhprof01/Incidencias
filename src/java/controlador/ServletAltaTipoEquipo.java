 ...
 * @author david
 */
public class ServletAltaTipoEquipo extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (listaErrores.isEmpty()) {
                ...
                iCAD.insertarTipoEquipo(tipoEquipo);
                request.setAttribute("mensajeUsuario", "Tipo de equipo creado correctamente");
                ...
                request.getRequestDispatcher("altatipoequipo.jsp").forward(request, response);
            }
