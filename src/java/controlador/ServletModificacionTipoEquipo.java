 ...
 * @author david
 */
public class ServletModificacionTipoEquipo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (listaErrores.isEmpty()) {
                ...
                tipoEquipo.setCodigo(request.getParameter("codigo"));
                tipoEquipo.setNombre(request.getParameter("nombre"));              
                iCAD.modificarTipoEquipo(tipoEquipo.getTipoEquipoId(),tipoEquipo);
                request.setAttribute("mensajeUsuario", "Tipo de equipo modificado correctamente");
                ...
                request.getRequestDispatcher("modificaciontipoequipo.jsp").forward(request, response);
            }
