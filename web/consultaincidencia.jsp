...
<%@include file="includes/cabecera.jsp" %>
            ...
            <div id="content">
                <h2 class="formulario">Detalle de Incidencia</h2>
<%@include file="includes/mensajeusuario.jsp" %>
                <%
                    ...
                    if (incidencia == null) {
                            ...
                            request.setAttribute("mensajeUsuario", "La incidencia no existe");
                ...
                <form name="bajaIncidencia">
                    ...
                    %>
                    <p class="botones">
                        <a href="listaincidencias.jsp"><input align="center" type="button" value="Volver"/></a>
                    </p>
                </form>
            </div>
